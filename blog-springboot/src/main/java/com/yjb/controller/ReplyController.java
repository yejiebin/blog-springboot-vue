...
import com.yjb.service.ReplyService;
...
public class ReplyController {
    ...
    public Result sendReply(@PathVariable("discussId") Long discussId, String replyBody, Long rootId) {
    ...
    public Result adminDeleteDiscuss(@PathVariable Long replyId) {
        if (!FormatUtil.checkPositive(replyId))
            return Result.create(StatusCode.ERROR, "参数错误");
